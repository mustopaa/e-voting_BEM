			...
			<div class="card">
				<div class="box-inner">
					<div class="card-header">
						<div class="row">
							<div class="col-lg-6">
								<h2 class="card-title">Daftar Hadir PEMIRA</h2>
							</div>
							<div class="col-lg-6 text-right">
								<a href="<?php echo base_url('index.php/admin/cetakdaftarhadir'); ?>"> <button
										class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-save"></span> Download Daftar
										Hadir</button> </a>
							</div>
						</div>
					</div>
