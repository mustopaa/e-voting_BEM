        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Identitas Universitas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card">
	<div class="box-inner">
		<div class="card-header">
			<h2 class="card-title"> Identitas Universitas </h2>
		</div>
		<div class="card-body">
			...
			<div style="">
				...
				?>
					...
					<div class="card">
						<div class="box-inner">
							<div class="card-header">
								<h2 class="card-title">Data Universitas</h2>
							</div>
							<div class="card-body">
								...
								?>
								<label class="label-control">Nama Universitas</label>
								<?php
									$form_attribute = array(
										'type'		=> 'text',
										'class'		=> 'form-control',
					...
					<div class="col-lg-6">
						<div class="card">
							<div class="box-inner">
								<div class="card-header">
									<h2 class="card-title">Kepala Universitas</h2>
								</div>
								<div class="card-body">
									<label class="label-control">Nama Universitas </label>
									<?php
