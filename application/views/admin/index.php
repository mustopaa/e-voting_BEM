					...
					<div class="card">
						<div class="box-inner">
							<div class="card-header">
								<h2 class="card-title">Data PEMIRA</h2>
							</div>
							<div class="card-body">
                                ...
                                echo form_input($form_attribute);
                                ?><br />
								<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Simpan
									Data</button>
								<?php
                                echo form_close();
                                ?>
					...
					<div class="card">
						<div class="box-inner">
							...
							<div class="card-body">
								...
								<p>Fitur ini digunakan Apabila telah selesai melakukan pemilihan dan telah Mengunduh <a
										href="<?php echo base_url('index.php/admin/cetakdaftarhadir'); ?>">Daftar Hadir</a> dan <a
										href="<?php echo base_url('index.php/admin/laporan'); ?>">Laporan Pemilihan</a> dan ingin Melakukan
									Pemilihan di Tahun berikutnya</p>
								...
								<?php } ?>
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#reset"><span
										class="glyphicon glyphicon-remove"></span> Reset Data Pemilihan</button>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<a href="<?php echo base_url('index.php/admin/resetdata'); ?>"><button type="button"
					...
					<div class="col-lg-6">
						<div class="card">
							<div class="box-inner">
								...
								<div class="card-body">
									<p>Fitur ini digunakan apabila Seorang Pemilih melaporkan bahwa dia Belum pernah memilih Sebelumnya
										tetapi Usernya telah dikunci karena Telah Memilih <b>(Usernya digunakan oleh orang lain)</b> </p>
									<hr />
                                    ...
                                    ?>
									<br />
									<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-remove"></span> Reset
										User</button>
									<?php
                                    echo form_close();
                                    ?>
